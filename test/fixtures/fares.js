import { CodeTable } from "@gb-transit/fares-source";
const TICKETS = {
    SOS: ["ANYTIME S", "S"],
    SVS: ["OFF-PEAK S", "S"],
    SOR: ["ANYTIME R", "R"],
 ...
 * fare in no category.
 */
export function feed({ stations, clusters = [], flows, nonDerivable = [] }) {
    ...
    return {
        ...
        ticketTypes: Object.entries(TICKETS).map(([code, [description, ticketType]]) => ({
