import { type RouteingData, RouteingNetwork } from "@gb-transit/routeing-source";
 ...
 */
export function network(): RouteingNetwork {
  const links: [string, string, number][] = [["AAA", "XXX", 5], ["XXX", "BBB", 5], ["AAA", "ZZZ", 20], ["YYY", "AAA", 1]];
